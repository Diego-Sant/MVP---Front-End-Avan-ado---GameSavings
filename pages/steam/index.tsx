...
import SteamHighLights from "@/components/SteamHighlights";
...
const SteamPage = () => {
    ...
    const filteredData = data ? data.filter((game: any) => game.price <= maxPrice) : [];
                ...
                <div className="relative max-w-[1064px] m-auto w-[100%]">
                    ...
                    <div className="flex flex-col items-center justify-center lg:justify-start lg:items-start">
                        ...
                        <div className="flex items-center gap-x-2 mb-4 mt-[3.375rem]">
                            ...
                            <Image width={30} height={18.3} src="/images/MaisBaratosSteam.svg" alt="Ícone de um computador" />
                            </div>
