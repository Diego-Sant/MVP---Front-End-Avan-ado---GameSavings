...
const KinguinPage = () => {
    ...
    const {data} = useSWR(`/api/news`, fetchPosts);
                ...
                <div className="relative max-w-[1064px] m-auto w-[100%]">
                    ...
                    <div className="flex flex-col items-center justify-center lg:justify-start lg:items-start">
                        ...
                        <div className="flex items-center gap-x-2 mb-4 mt-[3.375rem]">
                            ...
                            <Image width={33} height={33} src="/images/Novidade.svg" alt="Ícone de exclamação" />
                            </div>
                            <p className="text-white uppercase text-[15px] sm:text-[24px] font-semibold">Novidades</p>
                        </div>
